...
import { z } from 'zod';
import { registerWithEmail, signInWithGoogle, signInWithApple, getFirebaseErrorKey } from '@/lib/firebase/auth';
...
export function RegisterForm() {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      ...
      setError(errorKey ? tErrors(errorKey) : tErrors('registrationFailed'));
    } finally {
      setLoading(false);
    }
  };
