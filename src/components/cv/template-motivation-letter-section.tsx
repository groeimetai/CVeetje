...
interface TemplateMotivationLetterSectionProps {
...
export function TemplateMotivationLetterSection({
  linkedInData,
  jobVacancy,
  credits,
  language,
  onCreditsUsed,
  onTokenUsage,
}: TemplateMotivationLetterSectionProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/templates/motivation', {
        method: 'POST',
  ...
  const handleDownload = async (format: 'pdf' | 'docx') => {
    ...
    try {
      const response = await fetch('/api/templates/motivation/download', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          format,
