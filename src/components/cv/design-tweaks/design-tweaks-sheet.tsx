...
// ============ Wrapper — routes v1 vs v2 tweak sheets ============
 ...
 *
 * The legacy v1 sheet implementation lives below as `DesignTweaksSheetV1`.
 */
export function DesignTweaksSheet(props: DesignTweaksSheetProps) {
  const isV2 = (props.tokens as unknown as { engineVersion?: string })?.engineVersion === 'v2';
  if (isV2) {
    return (
      <DesignTweaksSheetV2
        open={props.open}
