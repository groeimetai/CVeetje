...
export const creativityConstraints = {
  ...
  creative: {
    ...
    allowedHeaderVariants: ['simple', 'accented', 'banner', 'split', 'asymmetric'] as const,
    allowedSectionStyles: ['clean', 'underlined', 'boxed', 'timeline', 'accent-left', 'card', 'alternating', 'magazine'] as const,
